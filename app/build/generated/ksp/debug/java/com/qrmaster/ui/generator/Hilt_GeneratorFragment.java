...
public abstract class Hilt_GeneratorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GeneratorFragment() {
    super();
  }

  Hilt_GeneratorFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GeneratorFragment_GeneratedInjector) this.generatedComponent()).injectGeneratorFragment(UnsafeCasts.<GeneratorFragment>unsafeCast(this));
    }
  }
